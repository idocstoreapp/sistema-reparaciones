-- ============================================
-- CORREGIR POLÍTICAS RLS DE salary_settlements
-- ============================================
...
-- 1. Crear función helper para verificar si el usuario es admin
...
-- 5. Agregar política de UPDATE para admins (por si acaso)
